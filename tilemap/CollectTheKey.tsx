...
<tileset version="1.2" tiledversion="1.2.0" name="CollectTheKey" tilewidth="70" tileheight="146" tilecount="177" columns="0:
 <grid orientation="orthogonal" width="1" height="1", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
case 3:
...
break;
case 73:
 tile = new TiledirtLedgeLeft.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 74:
 tile = new TiledirtLedgeRight.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 75:
...
break;
case 116:
  <image width="5" height="24" source="../images/grassLedgeLeft.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 117:
  <image width="5" height="24" source="../images/grassLedgeRight.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 118:
...
break;
case 121:
  tile = new Tilehill_large.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 122:
  tile = new Tilehill_largeAlt.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 123:
  <image width="48" height="106" source="../images/hill_small.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 124:
  <image width="48" height="106" source="../images/hill_smallAlt.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 125:
...
break;
case 143:
tile = new Tile("Tilep1.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 149:
...
break;
case 152:
 tile = new TilepokerMad.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 153:
...
break;
case 183:
  <image width="54" height="31" source="../images/snailWalk1.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 184:
...
break;
case 201:
 tile = new TilesnowLedgeRight.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
tile.isSolid = true;
break;
case 202:

...
public class TileFactory {
    ...
    public Tile createTile(int mapIcon) {
        ...
        switch (mapIcon) {
            ...
            break;
            case 1:
            tile = new Tile("bg_castle.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 2:
            ...
            break;
            case 145:
               tile = new Tile("p1_walk01.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 146:
               tile = new Tile("p1_walk02.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 147:
               tile = new Tile("p1_walk03.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 148:
               tile = new Tile("p1_walk04.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 149:
               tile = new Tile("p1_walk05.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 150:
               tile = new Tile("p1_walk06.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 151:
               tile = new Tile("p1_walk07.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 152:
               tile = new Tile("p1_walk08.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 153:
            ...
            break;
            case 154:
               tile = new Tile("p1_walk11.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 155:
            ...
            break;
            case 161:
               tile = new Tile("Pause.jpg", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 162:
            ...
            break;
            case 164:
               tile = new Tile("Play.jpg", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 165:

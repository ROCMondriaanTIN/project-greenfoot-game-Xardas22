...
public class TileFactory {
    ...
    public static Tile createTile(int mapIcon) {
        ...
        switch (mapIcon) {
            ...
            break;
            case 73:
             tile = new Tile ("TiledirtLedgeLeft.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 74:
             tile = new Tile ("TiledirtLedgeRight.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
            tile.isSolid = true;
            break;
            case 75:
